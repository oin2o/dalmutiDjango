...
class LoginView(generic.ListView):
    template_name = "dalmutip/login.html"
...
class MainView(generic.ListView):
    template_name = "dalmutip/main.html"
...
class RuleView(generic.DetailView):
    template_name = "dalmutip/rule.html"
...
class HonorView(generic.DetailView):
    template_name = "dalmutip/honor.html"
...
class RankView(generic.DetailView):
    template_name = "dalmutip/ranking.html"
...
class PrivateGameView(generic.DetailView):
    ...
    def post(self, request, gamename, username):
        ...
        if game:
            return HttpResponseRedirect(reverse('dalmutip:ingame', args=(game.gamename, user.username,)))
        else:
            game_list = Game.objects.filter(round__lt=13).order_by('-gamename')
...
class InGameView(generic.DetailView):
    template_name = "dalmutip/ingame.html"
...
class GameQuitView(generic.DetailView):
    ...
    def get(self, request, gamename, username):
        ...
        return HttpResponseRedirect(reverse('dalmutip:main', args=(username,)))
...
class IntrusionView(generic.DetailView):
    ...
    def get(self, request, gamename, username):
        ...
        return HttpResponseRedirect(reverse('dalmutip:ingame', args=(currentgamename, username,)))
...
class TelegramView(generic.DetailView):
    ...
    def get(self, request, gamename, username):
        ...
        bot.sendMessage(chat_id='-413309173',
                        text='[게임코드:' + game.gamecode + '](https://35.230.124.241:8443/dalmutip/telegram/login/' + game.gamename + '/' + game.gamecode + '/)',
